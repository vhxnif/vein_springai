...
Groq is an extremely fast, LPU™ based, AI Inference Engine that support various AI Models, supports `Tool/Function Calling` and exposes a `OpenAI API` compatible endpoint.

Spring AI integrates with the Groq by reusing the existing OpenAI client. For this you need to obtain a Groq Api Key, set the base-url to api.groq.com/openai/v1 and select one of the provided Groq models.
...
- **Set the Groq URL**: You have to set the `spring.ai.openai.base-url` property to `https://api.groq.com/openai/v1`.
...
<td class="tableblock halign-left valign-top"><p>The URL to connect to. Must be set to <code>https://api.groq.com/openai/v1</code></p></td>
<td class="tableblock halign-left valign-top"><p>-</p></td>
</tr>
<tr>
<td class="tableblock halign-left valign-top"><p>spring.ai.openai.api-key</p></td>
<td class="tableblock halign-left valign-top"><p>The Groq API Key</p></td>
<td class="tableblock halign-left valign-top"><p>-</p></td>
</tr>
</tbody>
</table>
...
<tr>
<td class="tableblock halign-left valign-top"><p>spring.ai.openai.chat</p></td>
<td class="tableblock halign-left valign-top"><p>Enable OpenAI chat model.</p></td>
...
<td class="tableblock halign-left valign-top"><p>Optional overrides the spring.ai.openai.base-url to provide chat specific url. Must be set to <code>https://api.groq.com/openai/v1</code></p></td>
<td class="tableblock halign-left valign-top"><p>-</p></td>
</tr>
<tr>
...
<td class="tableblock halign-left valign-top"><p>The available model names are <code>llama3-8b-8192</code>, <code>llama3-70b-8192</code>, <code>mixtral-8x7b-32768</code>, <code>gemma2-9b-it</code>.</p></td>
<td class="tableblock halign-left valign-top"><p>-</p></td>
</tr>
<tr>
