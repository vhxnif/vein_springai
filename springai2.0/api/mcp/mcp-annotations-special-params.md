...
<tbody>
<tr>
<td class="tableblock halign-left valign-top"><p><code>request()</code></p></td>
<td class="tableblock halign-left valign-top"><p>The original MCP request (e.g., <code>CallToolRequest</code>, <code>ReadResourceRequest</code>). Use <code>request().progressToken()</code> to access the progress token.</p></td>
</tr>
<tr>
<td class="tableblock halign-left valign-top"><p><code>exchange()</code></p></td>
<td class="tableblock halign-left valign-top"><p>The underlying server exchange (<code>McpSyncServerExchange</code> / <code>McpAsyncServerExchange</code>). Available in stateful mode only; <code>null</code> in stateless mode.</p></td>
</tr>
<tr>
<td class="tableblock halign-left valign-top"><p><code>sessionId()</code></p></td>
<td class="tableblock halign-left valign-top"><p>The current session identifier.</p></td>
</tr>
<tr>
<td class="tableblock halign-left valign-top"><p><code>clientInfo()</code></p></td>
<td class="tableblock halign-left valign-top"><p>The client implementation info (<code>Implementation</code>).</p></td>
</tr>
<tr>
<td class="tableblock halign-left valign-top"><p><code>clientCapabilities()</code></p></td>
<td class="tableblock halign-left valign-top"><p>The capabilities declared by the client.</p></td>
</tr>
<tr>
<td class="tableblock halign-left valign-top"><p><code>requestMeta()</code></p></td>
<td class="tableblock halign-left valign-top"><p>Metadata map from the <code>_meta</code> field of the request. Prefer this over injecting <code>McpMeta</code> when already using a context object.</p></td>
</tr>
<tr>
<td class="tableblock halign-left valign-top"><p><code>transportContext()</code></p></td>
<td class="tableblock halign-left valign-top"><p>The transport-level context (<code>McpTransportContext</code>).</p></td>
</tr>
</tbody>
</table>
...
Server Annotations MCP Annotations Examples
